...
public class ColumnNames {
    ...
    public ColumnNames(String xmlId, String permanentLink, String successor, String predecessor, String generationId, String validTo, String validFrom, String termPublicUrl) {
        this.xmlId = xmlId;
